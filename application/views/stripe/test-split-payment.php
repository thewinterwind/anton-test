        ...
        <div class="col-md-12 col-md-offset-3">
            <div class="card card-default credit-card-box p-3">
                ...
                <div class="card-body">
                    ...
                    <form role="form" action="<?php echo base_url('process-split-payment/' . $acct_id); ?>" method="post" class="require-validation"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-primary btn-lg btn-block ml-4" type="submit">Pay Now ($100 AUD)</button>
                            </div>
                        </div>
...
function stripeTokenHandler(token) {
  ...
  hiddenInput.setAttribute('PostalCode', 'hidden');
