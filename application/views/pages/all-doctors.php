...
<?php if($this->session->flashdata('error-payment')){ ?>
    <div class="alert alert-danger text-center my-auto">
            <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
            <p class="my-auto"><?php echo $this->session->flashdata('error-payment'); ?></p>
    </div>
<?php } ?>
...
<table class="table">
    ...
    <tbody>
        ...
        <tr>
            <?php if($acct['business_type'] == 'company') : ?>
                <td>Company</td>
                <td><?php echo $acct['business_profile']['name']; ?></td>
                <td> N/A </td>
                <td> N/A </td>
            <?php else : ?>
                <td>Individual</td>
                <td> N/A </td>
                <td><?php echo $acct['individual']['first_name']; ?></td>
                <td><?php echo $acct['individual']['last_name']; ?></td>
            <?php endif; ?>
            <td>
...
<form action="<?php echo base_url('/add-doctors-account'); ?>" method="POST" id="individual" hidden>
    ...
    <div class="form-row">
        <div class="form-group col-md-3">
            ...
            <input type="text" name="individual_account_holder" class="form-control" required>
        </div>
        <div class="form-group col-md-3">
            <label for="">Account Type:</label>
            <input type="text" name="individual_account_type" class="form-control" required>
        </div>
        <div class="form-group col-md-3">
            <label for="">Routing Number:</label>
            <input type="text" name="individual_routing_number" class="form-control" required>
        </div>
        <div class="form-group col-md-3">
            <label for="">Account Number:</label>
            <input type="text" name="individual_account_number" class="form-control" required>
        </div>
    </div>
